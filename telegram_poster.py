...
from story_gen import generate_poll_options_openai, generate_story_continuation_openai
...
# --- Configuration ---
load_dotenv()
print(os.getenv("MAX_CONTEXT_CHARS", 15000))
...
OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gemini-2.5-pro-preview-05-06")
